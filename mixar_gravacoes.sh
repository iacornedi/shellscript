...
#  Desenvolvi este scrip como solução paleativa para um problema que ocorria por causa do Elastix+Asternic.
#  A pessoa que implantou o asterisk não sabia por que ocorria este problema e não tive oportunidade  
